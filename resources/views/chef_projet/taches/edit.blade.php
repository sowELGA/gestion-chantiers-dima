    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="px-6 py-5 border-b border-slate-100">
                <h3 class="font-semibold text-[#0F172A]">{{ $tache->nomTache }}</h3>
            ...
            <form method="POST" action="{{ route('chef_projet.taches.update', [$chantier->id, $tache->id]) }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="type"
                            ...
                            <option value="gros_oeuvre" {{ old('type', $tache->type) === 'gros_oeuvre' ? 'selected' : '' }}>
                                Gros œuvre
                            </option>
                            <option value="second_oeuvre"
                                {{ old('type', $tache->type) === 'second_oeuvre' ? 'selected' : '' }}>
                                Second œuvre
                            </option>
                        </select>
                    </div>
                        ...
                        <select name="phase_id"
                            ...
                            @foreach ($phases as $phase)
                                <option value="{{ $phase->id }}"
                                    {{ old('phase_id', $tache->phase_id) == $phase->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="sous_traitant" value="{{ old('sous_traitant', $tache->sous_traitant) }}"
                ...
                <div>
                    ...
                    <textarea name="descriptionTache" rows="3"
                        class="w-full px-4 py-2.5 border border-slate-300 rounded-lg
                                 text-sm focus:outline-none focus:ring-2
