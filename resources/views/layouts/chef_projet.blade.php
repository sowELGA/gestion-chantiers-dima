...
<head>
    ...
    <title>@yield('title', 'Dima Groupe') — Chef de projet</title>
...
<body class="bg-[#F8FAFC] text-[#0F172A] font-sans antialiased" x-data="{ sidebarOpen: true, sidebarMobile: false }">
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'"
        ...
        <div class="px-4 py-4 border-t border-slate-700/50">
            ...
            <p x-show="!sidebarOpen" class="text-[10px] text-slate-600 text-center">v1.0</p>
        </div>
    ...
    <div :class="sidebarOpen ? 'lg:ml-64' : 'lg:ml-16'"
        ...
        <header
            ...
            <div class="flex items-center gap-4">
                <button @click="sidebarMobile = true" class="lg:hidden text-slate-500 hover:text-[#0F172A]">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">
                        @yield('page_subtitle', 'Gestion de vos chantiers et tâches.')
                    </p>
                </div>
            </div>
